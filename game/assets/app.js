...
exports.ajaxHelper = exports.fakeAjax = undefined;
...
var responses = {
    ...
    getQuestion: {
        1: [{
            ...
            id: 2,
            answer: "1",
            options: ["Prints \u201Ctrue\u201D", "Returns an error for the second function, no return clause", "Returns an error, the first function is not correctly defined", "Prints \u201Cfalse\u201D"],
            code: "var inm = (x: Int, y:Int) => x*y\n                    def mul  (x: Int, y: Int): Int = {\n                        var inm = x*y\n                        inm\n                    }\n                    println((inm(3, 4) == mul(2, 6)))"
        }, {
            id: 3,
            answer: "2",
            options: ["Prints the string \u201Cfoo bar\u201D", "Error. Fix is in the line: val str = \"\"", "Error. Fix is in the line: str= x + \" \" + y", "Error. Fix is in the line: val c = func(a, b)"],
        ...
        2: [{
            ...
            options: ["A process that creates the SparkContext and runs the main() function", "A high rank in the Protoss Templar Caste", "A node that can run application code in the cluster", "A process launched by an application that runs tasks."]
        }],
        3: [{
            id: 1,
            answer: "3",
            title: "In order to partition a table in MSSQL, you need the following pre-requisites:",
            options: ["A partition function", "A partition schema", "A partition column", "All of above"]
        }],
        4: [{
            id: 1,
            answer: "4",
        ...
        5: [{
            ...
            answer: "2",
            title: "What’s the most efficient way to append the character “c” to: Seq(“a”, “b”)?",
            options: ["Seq(\u201Ca\u201D, \u201Cb\u201D) += \u201Cc\u201D", "Seq(\u201Ca\u201D, \u201Cb\u201D) ++ Seq(\u201Cc\u201D)", "Seq(\u201Ca\u201D, \u201Cb\u201D) += Seq(\u201Cc\u201D)", "Seq(\u201Ca\u201D, \u201Cb\u201D) :+ \u201Cc\u201D"]
        }],
        6: [{
            id: 1,
            answer: "1",
...
var fakeAjax = function fakeAjax(url, data) {
...
var ajaxHelper = function ajaxHelper(url) {
...
},{"./loader.js":7,"jquery":1}],4:[function(require,module,exports){
"use strict";
...
_game2.default.init();
_leaderboard2.default.init();

},{"./game.js":5,"./leaderboard.js":6,"jquery":1}],5:[function(require,module,exports){
"use strict";
...
var _ajaxHelper = require("./ajax-helper.js");
...
var $questionBody = (0, _jquery2.default)(".question-body");
var $questionAnswers = (0, _jquery2.default)(".question-answers");
var $nextQuestion = (0, _jquery2.default)(".js-next-question");
var $categoryBtn = (0, _jquery2.default)(".js-btn-category");
var $startBtn = (0, _jquery2.default)(".js-btn-start");
var $exitBtn = (0, _jquery2.default)(".js-btn-exit");
var $userPanel = (0, _jquery2.default)(".user-panel");
var $loginForm = (0, _jquery2.default)(".js-login");

var user = {
    isLoggedIn: false,
    queuedEv: null,
    showLogin: function showLogin(qEv) {
        user.queuedEv = qEv;
        game.updateScreen("login");
        return;
    },
    login: function login(userId, username) {
        user.userId = userId;
    ...
    create: function create(username) {
        return (0, _ajaxHelper.ajaxHelper)("http://devtalks.emag.ro/index.php?emag/registerUser", "POST", { user: username });
        // return fakeAjax("createUser");
    },

    incrementScore: function incrementScore() {
        $userPanel.find(".points").html(+$userPanel.find(".points").html() + 10);
        (0, _ajaxHelper.ajaxHelper)("http://devtalks.emag.ro/index.php?emag/updateScore", "POST", { id: user.userId });
    }
};

var userActions = {
    onCategoryBtnClick: function onCategoryBtnClick(ev) {
        ev.preventDefault();
    ...
    onNextQuestionClick: function onNextQuestionClick(ev) {
        ev.preventDefault();
        question.validate();
        question.change();
    },

    onStartClick: function onStartClick(ev) {
        ev.preventDefault();

        var $error = $loginForm.find(".error");
        var username = $loginForm.find("input").val();

        $error.removeClass("is-visible");
        if (!username) {
            $error.addClass("is-visible").html("Please enter an username.");
        } else {
            user.create(username).then(function (newUser) {
                return user.login(newUser.id, newUser.name);
            }).fail(function (err) {
                _loader2.default.hide();
    ...
    onExitClick: function onExitClick(ev) {
        ev.preventDefault();
        user.logout();
    }
};
...
var game = {
    ...
    init: function init() {
        if ((0, _jquery2.default)("#editor").length) {
    ...
    updateScreen: function updateScreen() {
        var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "categories";
        return $container.attr("data-screen", type);
    },
    ...
    (0, _jquery2.default)(ev.target).parent().siblings().find("input").prop("checked", false);
}
...
var question = {
    ...
    change: function change() {
        if (question.currentIndex < question.currentCategory.length) {
            var q = question.currentCategory[question.currentIndex++];
            if (q) {
                if (!q.options) {
                    q.options = [];
    ...
    generateCheckbox: function generateCheckbox($wrapper, answer) {
        var $option = (0, _jquery2.default)("<label class=\"mar-b-sm\"><div class=\"checkbox-placeholder inline--v-middle radius box mar-r-xs shadow\"></div>" + answer + "</label>");
        var $input = (0, _jquery2.default)("<input type=\"checkbox\" value=\"" + answer + "\">");
        $input.on("change", onInputCheckboxChange);
        $option.prepend($input);
        $wrapper.append($option);
    },

    render: function render(q) {
        ...
        if (q.options.length) {
            ...
            if (q.code) {
                ...
                var $optionsWrapper = (0, _jquery2.default)("<div class='checkboxes-wrapper pad-l-md'>");
    ...
    validate: function validate() {
        var q = question.currentCategory[question.currentIndex - 1];
        ...
        if (q.code) {
            if (q.options.length) {
                ...
                (0, _ajaxHelper.ajaxHelper)("http://devtalks.emag.ro/index.php?emag/sendPHPAnswer", "POST", { id: q.id, code: editor.getValue() }).then(function (data) {
                    // fakeAjax("").then( (data) => {
...
},{"./ajax-helper.js":3,"./loader.js":7,"jquery":1}],6:[function(require,module,exports){
"use strict";
...
var $leaderboard = (0, _jquery2.default)(".leaderboard-box ol");
...
var leaderboard = {
    ...
    getLeaderboard: function getLeaderboard() {
        (0, _ajaxHelper.ajaxHelper)("http://devtalks.emag.ro/index.php?emag/status/").then(function (data) {
...
},{"./ajax-helper.js":3,"jquery":1}],7:[function(require,module,exports){
"use strict";
